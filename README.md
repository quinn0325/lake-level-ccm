...
│   ├── 07_tables/                one script per dissertation table and appendix
│   └── 08_dataset/
...
7. **Generate tables and figures** — `run_local.py --stage figures`, then
   `python code/07_tables/build_appendices.py` and
   `python code/07_tables/build_appendices_en.py`.
...
`appendices/` holds the eleven appendix tables as CSV, regenerated by
